export const professionalExperiences = [
		...
		missions: [
			{
				...
				stack: ['Mentoría', 'Comunicación', 'Feedback', 'Pedagogía', 'Empatía'],
			},
			{
			...
			},
			{
				...
				stack: ['TypeScript', 'Node.js', 'Angular', 'RxJS', 'Cypress'],
			},
			{
	...
	},
	{
		...
		stack: ['React.js', 'Node.js', 'TypeScript', 'MySQL'],
	},
	{
		company: 'WINSTATE',
		...
		stack: ['React.js', 'Node.js', 'MySQL', 'Jest'],
	},
];
