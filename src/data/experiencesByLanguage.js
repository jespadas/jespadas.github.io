...
export const experiencesByLanguage = {
	en: [
			...
			missions: [
				{
					...
					context:
						'Technical mentoring and day-to-day support for work-study students within the team.',
					highlights: [
				...
				},
				{
					...
					context:
						'Modernization of multi-device point-of-sale interfaces based on micro frontends.',
					highlights: [
				...
				},
				{
					...
					context:
						'Web application for prospecting, selling, and invoicing mutual insurance products.',
					highlights: [
				...
				},
				{
					...
					context:
						'Application for creating, updating, and executing ground tests on Airbus FAL lines.',
					highlights: [
				...
				},
				{
					...
					context:
						'Web application for aircraft configuration, invoicing, and change management in a sales process.',
					highlights: [
		...
		},
		{
			...
			summary:
				'Designed, developed, and maintained web applications for different clients, covering analysis, frontend, backend, testing, deployment, and support.',
			highlights: [
		...
		},
		{
			...
			summary:
				'Delivered a complete web application from functional analysis to deployment and user documentation.',
			highlights: [
	...
	es: [
		{
			...
			missions: [
				...
				},
				{
					...
					context:
						'Aplicación web para configuración, facturación y modificación de aviones dentro de un proceso de venta.',
					highlights: [
	...
	fr: [
			...
			missions: [
				{
					...
					context:
						'Accompagnement technique et suivi quotidien des étudiants en alternance au sein de l’équipe.',
					highlights: [
				...
				},
				{
					...
					context:
						'Modernisation des interfaces d’une application point de vente multi-device basée sur des micro frontends.',
					highlights: [
				...
				},
				{
					...
					context:
						'Application web destinée à la prospection, la vente et la facturation de produits mutualistes.',
					highlights: [
				...
				},
				{
					...
					context:
						'Application de création, modification et exécution de tests au sol sur les lignes FAL Airbus.',
					highlights: [
				...
				},
				{
					...
					context:
						'Application web de configuration, facturation et modification d’avions dans un processus de vente.',
					highlights: [
		...
		},
		{
			...
			location: 'Toulouse, France · Remote',
			summary:
				'Conception, développement et maintenance d’applications web pour différents clients, couvrant analyse, frontend, backend, tests, déploiement et support.',
			highlights: [
		...
		},
		{
			...
			location: 'Toulouse, France',
			summary:
				'Développement complet d’une application web, de l’analyse fonctionnelle au déploiement et à la documentation utilisateur.',
			highlights: [
